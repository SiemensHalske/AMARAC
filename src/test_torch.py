...
model = keras.Sequential(
    [
        ...
        layers.BatchNormalization(),
        layers.Reshape((2, 2, 1600)),
        layers.Conv2D(1024, kernel_size=(2, 2), activation="relu"),
        layers.BatchNormalization(),
        layers.MaxPooling2D(pool_size=(2, 2)),
        layers.Flatten(),
        layers.Dropout(0.2),
        layers.Conv2D(128, kernel_size=(3, 3), activation="relu", padding="same", kernel_regularizer=l1_l2(l1=L1, l2=L2)),
        layers.BatchNormalization(),
        layers.Conv2D(64, kernel_size=(3, 3), activation="relu", padding="same", kernel_regularizer=l1_l2(l1=L1, l2=L2)),
        layers.Dropout(0.2),
